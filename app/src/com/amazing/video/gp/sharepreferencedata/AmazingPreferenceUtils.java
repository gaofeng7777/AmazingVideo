package com.amazing.video.gp.sharepreferencedata;
...
public final class AmazingPreferenceUtils {
	...
	public AmazingPreferenceUtils() {
		this(MyApplication.getContext(), AmazingPreferenceKeys.PERFERENCE);
	}

	public AmazingPreferenceUtils(final Context context, String sharedPreferencesName) {
		this.mPreference = context.getApplicationContext().getSharedPreferences(AmazingPreferenceKeys.PERFERENCE, Context.MODE_PRIVATE);
	}
