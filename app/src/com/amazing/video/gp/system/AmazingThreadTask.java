package com.amazing.video.gp.system;
...
public abstract class AmazingThreadTask<Params, Progress, Result> {

	private HandlerThread mHandlerThread;
	private AmazingTaskHandler mHandler;
	private AmazingTaskHandler mUiHandler;
	...
	public AmazingThreadTask() {
		//降低线程的优先级
		mHandlerThread = new HandlerThread("ThreadTask", android.os.Process.THREAD_PRIORITY_BACKGROUND);
		mHandlerThread.start();

		mHandler = new AmazingTaskHandler(mHandlerThread.getLooper());
		mUiHandler = new AmazingTaskHandler(Looper.getMainLooper());
	}
	...
	protected synchronized void onAmazingProgressUpdate(Progress... values) {
	}
	...
	private class AmazingTaskHandler extends Handler {

		public AmazingTaskHandler(Looper looper) {
			super(looper);
		}
		...
		public void handleMessage(Message msg) {
			...
			case MESSAGE_PROGRESS:
				onAmazingProgressUpdate((Progress[]) msg.obj);
				break;
			}
		}
	}
