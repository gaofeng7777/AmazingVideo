...
public class AmazingProgressView extends View {
	...
	public AmazingProgressView(Context paramContext) {
		super(paramContext);
		init();
	}

	public AmazingProgressView(Context paramContext, AttributeSet paramAttributeSet) {
