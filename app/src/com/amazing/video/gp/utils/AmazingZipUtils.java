...
public class AmazingZipUtils {
	 ...
	 * @throws Exception
	 */
	public static java.util.List<java.io.File> GetAmazingFileList(String zipFileString, boolean bContainFolder, boolean bContainFile) throws Exception {
		java.util.List<java.io.File> fileList = new java.util.ArrayList<java.io.File>();
		java.util.zip.ZipInputStream inAmazingZip = new java.util.zip.ZipInputStream(new java.io.FileInputStream(zipFileString));
		java.util.zip.ZipEntry zipEntry;
		String szName = "";

		while ((zipEntry = inAmazingZip.getNextEntry()) != null) {
	 ...
	 * @throws Exception
	 */
	public static java.io.InputStream UpAmazingZip(String zipFileString, String fileString) throws Exception {
	 ...
	 * @throws Exception
	 */
	public static void UnAmziangZipFolder(String zipFileString, String outPathString) throws Exception {
	 ...
	 * @throws Exception
	 */
	public static void ZipAmazingFolder(String srcFileString, String zipFileString) throws Exception {
		...
		//压缩
		ZipAmazingFiles(file.getParent() + java.io.File.separator, file.getName(), outZip);
	 ...
	 * @throws Exception
	 */
	private static void ZipAmazingFiles(String folderString, String fileString, java.util.zip.ZipOutputStream zipOutputSteam) throws Exception {
		...
		if (file.isFile()) {
			...
			for (int i = 0; i < fileList.length; i++) {
				ZipAmazingFiles(folderString, fileString + java.io.File.separator + fileList[i], zipOutputSteam);
			}//end of for
